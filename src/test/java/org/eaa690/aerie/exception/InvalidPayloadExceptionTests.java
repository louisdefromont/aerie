...
public class InvalidPayloadExceptionTests {
    ...
    public void empty() throws Exception {
        Assert.assertNotNull(new InvalidPayloadException());
    }
    ...
    public void messageOnly() throws Exception {
        Assert.assertNotNull(new InvalidPayloadException(TEXT));
    }
    ...
    public void messageWithThrowable() throws Exception {
        Assert.assertNotNull(new InvalidPayloadException(TEXT, new Exception()));
    }
