...
/**
 * FakeHostnameVerifierTests.
 */
public class FakeHostnameVerifierTests {
     ...
     */
    private FakeHostnameVerifier fakeHostnameVerifier;
    ...
    public void verify() throws Exception {
        Assert.assertTrue(fakeHostnameVerifier.verify(TEXT, null));
    }
